...
//            int ticketThread = scan.nextInt();
            ...
            GUIInput gui_input = new GUIInput();
//            int hours = gui_input.getHour();
//            int minutes = gui_input.getMinutes();
//            int maxVisitors = gui_input.getMaxVisitor();
//            int totalTickets = gui_input.getMaxTicket();
//            int ticketThread = gui_input.getNumOfVisitor();
